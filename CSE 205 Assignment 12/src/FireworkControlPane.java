       ...
       public void handle(ActionEvent event)
        {
            ...
            {
            	fwPane.resume();		//plays animation
            }
            else if(event.getSource() == stop)
            {
            	fwPane.suspend();		//pauses animation
            }
         }
   ...
   private class SpeedHandler implements ChangeListener<Number>
    {
                             ...
                             Number oldValue, Number newValue)
         {
        	 ...
        	 int ratee = (int)rate;			//changes speed
        	 fwPane.setRate(ratee);
         }
     ...
     private class BeamHandler implements ChangeListener<Number>
      {
                            ...
                            Number oldValue, Number newValue)
           {
             ...
             /***to be completed***/
        	   double beamm = beam.getValue();
        	   int beammm = (int)beamm;			//changes beam number
        	   fwPane.setBeamNumber(beammm);
           }
     } //end of BeamListener
 }